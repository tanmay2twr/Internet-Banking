...
<script type="text/javascript">
	...
	function redirectPage(data) {
		...
		window.location.assign('http://localhost:8080/Wipro_Internet_Banking/TransferWithin.jsp?id=' + dataArray[0] + '&ifsc=' + dataArray[3] + '&acct=' + dataArray[1] + '&benfitName=' + dataArray[2]);
	}
</script>
</head>
